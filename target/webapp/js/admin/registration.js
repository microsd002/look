...
function CheckFirstName() {
	...
	outEl= document.getElementById("first_name1"), error = "";
...
function CheckSecondName() {
	...
	outEl= document.getElementById("second_name1");
...
function CheckThreeName() {
	...
	outEl= document.getElementById("three_name1");
...
function CheckTel() {
	...
	outEl= document.getElementById("tel1");
...
function CheckLogin() {
	...
	outEl= document.getElementById("username_registration1"), error = "";
...
function CheckPassword() {
	...
	outEl= document.getElementById("password_registration1");
